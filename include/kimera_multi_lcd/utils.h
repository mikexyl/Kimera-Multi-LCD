...
void MatToBowVectorMsg(const cv::Mat& mat, pose_graph_tools_msgs::msg::BowVector* msg);
...
size_t computeVLCFrameDescriptorBytes(const pose_graph_tools_msgs::msg::VLCFrameMsg& msg);
